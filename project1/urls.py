...
urlpatterns = [
    ...
    path('board/<int:pk>/', home.TopicListView.as_view(), name = 'board_topics'),
    path('board/<int:pk>/new/', home.new_board_topic, name = 'new_topic'),
    ...
    path('board/<int:pk>/topics/<int:topic_pk>/', home.PostListView.as_view(), name='topic_posts'),
